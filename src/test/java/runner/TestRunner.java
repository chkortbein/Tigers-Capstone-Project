...
@CucumberOptions(
		...
		glue = "step.definition", //we provide the path of step definition classes
		tags = "@completeDesktops", //with tags we will run our test cases
		dryRun = true, // DryRun checks if there is any missing step def
		monochrome = true, //this will mark a scenario failed if one step failed
